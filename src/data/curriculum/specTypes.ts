...
export const SPEC_TYPES: SpecType[] = [
  ...
  },
  {
    ...
    category: 'physical',
    description: 'Forces on a body as adjustable vectors; net force and resulting motion.',
    built: false,
  },
  {
    id: 'projectile',
  ...
  },
  {
    ...
    category: 'physical',
    description: 'Adjustable amplitude/frequency/phase for waves and SHM; superposition.',
    built: false,
  },
  {
    id: 'ray-diagram',
  ...
  },
  {
    ...
    label: 'Circuit',
    category: 'structural',
    description: 'Components in series/parallel; adjust values, see current and voltage.',
    built: false,
  },
  {
    id: 'molecule-3d',
